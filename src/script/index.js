...
let powerEchart = echarts.init(document.getElementById('power'))
let powerOption = {
  grid: {
    left: 0,
    right: 0,
...
let waterEnergyEchart = echarts.init(document.getElementById('waterEnergy'))
let waterEnergyOption = {
  title: {
    text: '7天用水总量:357',
    textStyle: {
      color: '#d4d4d5',
...
let lightEnergyEchart1 = echarts.init(document.getElementById('lightEnergy1'))
let lightEnergyOption1 = {
  grid: {
    left: 0,
    right: 0,
    top: 0,
...
let lightEnergyEchart2 = echarts.init(document.getElementById('lightEnergy2'))
let lightEnergyOption2 = {
  grid: {
    left: 0,
    right: 0,
    top: 0,
...
let humanTaffic = echarts.init(document.getElementById('humanTaffic'))
let humanTafficOption = {
  color: ['#3581ff', '#35ff6b'],
  legend: {
    right: 0,
    textStyle: {
...
for (let i = 0; length = data.length, i < length; i++) {
  let value1 = 100 - data[i].value
  let parkingLot = echarts.init(document.getElementById('pie' + i))
  let parkingLotOption = {
    grid: {
      left: 0,
      right: 0,
      top: 0,
