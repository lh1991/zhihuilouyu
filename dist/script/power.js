...
var subItem = echarts.init(document.getElementById('sub-item'));
var subItemOption = {
  tooltip: {
    trigger: 'item',
...
var floor = echarts.init(document.getElementById('floor'));
var floorOption = {
  color: ['#3398DB'],
  grid: {
    left: 20,
...
var loadCurve = echarts.init(document.getElementById('loadCurve'));
var loadCurveOption = {
  color: ['#3581ff', '#35ff6b'],
  grid: {
    left: 40,
...
var floorSubUse = echarts.init(document.getElementById('floorSubUse'));
var floorSubUseOption = {
  radar: [{
    indicator: [{ text: '办公室', max: 200 }, { text: '会议室', max: 200 }, { text: '洽谈室', max: 200 }, { text: '洗手间', max: 200 }, { text: '茶水间', max: 200 }],
    radius: 60,
    axisLine: {
      lineStyle: {
        type: 'dotted',
...
function randomData() {
  ...
  return {
    value: [now.getHours() + ': ' + (now.getMinutes() > 9 ? now.getMinutes().toString().replace(now.getMinutes().toString().substr(now.getMinutes().toString().length - 1, 1), '0') : '00'), Math.round(value)]
  };
}
...
var powercurve = echarts.init(document.getElementById('powercurvechart'));
var powercurveOption = {
  grid: {
    left: 30,
    right: 0,
    top: 30,
